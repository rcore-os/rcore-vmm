...
static int ide_base_read(uint32_t IOBASE, struct virt_device* dev, struct ide_base_data* base, uint16_t port,
...
static int ide_base_write(uint32_t IOBASE, struct virt_device* dev, struct ide_base_data* base, uint16_t port,
                          struct rvm_io_value* value) {
    ...
    case ISA_COMMAND:
        ...
        // base->cmd, base->secno, base->count);
        return 0;
    default:
...
void ide_init(struct virt_device* dev, int rvm_fd, int vmid) {
    ...
    struct rvm_guest_set_trap_args trap_base0 = {
        dev->vmid, RVM_TRAP_KIND_IO, IDE_BASE0, IDE_PORT_SIZE, (uint64_t)dev,
    };
    ioctl(dev->rvm_fd, RVM_GUEST_SET_TRAP, &trap_base0);

    struct rvm_guest_set_trap_args trap_base1 = {
        dev->vmid, RVM_TRAP_KIND_IO, IDE_BASE1, IDE_PORT_SIZE, (uint64_t)dev,
    };
...
// from qemu
static unsigned int default_ide_id_data[] = {
    0x90040,    0x100000,   0x2007e00,  0x3f,       0x0,        0x3030514d, 0x31203030, 0x20202020, 0x20202020,
    0x20202020, 0x2000003,  0x322e0004, 0x2020352b, 0x51452020, 0x20484d55, 0x44444152, 0x4b204953, 0x20202020,
    0x20202020, 0x20202020, 0x20202020, 0x20202020, 0x20202020, 0x80102020, 0xb000001,  0x2000000,  0x70200,
    0x100009,   0x2370003f, 0x1100000,  0x2710,     0x70007,    0x780003,   0x780078,   0x40000078, 0x0,
    0x0,        0x0,        0x0,        0x0,        0x1600f0,   0x74004021, 0x40214000, 0x40003400, 0x203f,
    0x0,        0x60010000, 0x0,        0x0,        0x0,        0x2710,     0x0,        0x0,        0x6000,
    0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,
    0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,
    0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,
    0x0,        0x0,        0x0,        0x10000,    0x0,        0x0,        0x0,        0x0,        0x0,
    0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,
    0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,
    0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,
    0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,        0x0,
