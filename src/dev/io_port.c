...
static int cmos_read(struct virt_device *dev, uint64_t port, uint8_t access_size, struct rvm_io_value *value) {
    printf("CMOS read handler\n");
    return 0;
}

static int cmos_write(struct virt_device *dev, uint64_t port, uint8_t access_size, struct rvm_io_value *value) {
    printf("CMOS write handler\n");
    return 0;
}

static int other_read(struct virt_device *dev, uint64_t port, uint8_t access_size, struct rvm_io_value *value) {
    printf("other read handler\n");
    return 1;
}

static int other_write(struct virt_device *dev, uint64_t port, uint8_t access_size, struct rvm_io_value *value) {
