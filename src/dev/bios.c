...
static int bios_read(struct virt_device *dev, uint64_t port, uint8_t access_size, struct rvm_io_value *value) {
...
static int bios_write(struct virt_device *dev, uint64_t port, uint8_t access_size, struct rvm_io_value *value) {
